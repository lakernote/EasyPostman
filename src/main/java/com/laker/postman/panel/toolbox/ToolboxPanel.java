...
public class ToolboxPanel extends SingletonBasePanel {
    ...
    private void initToolTabs() {
        // 1. Markdown 编辑器 - 文档编辑必备工具
        addToolTab(
                "Markdown",
                createThemedIcon("icons/edit.svg"),
                new MarkdownToolPanel()
        );

        // 2. JSON格式化 - API开发必备，使用频率最高
        addToolTab(
