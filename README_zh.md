...
| 🐧 **Ubuntu / Debian（x64）** | `easypostman_{版本号}_amd64.deb` | 适用于 `x86_64` / `amd64` 系统 |
| 🐧 **Ubuntu / Debian（ARM64）** | `easypostman_{版本号}_arm64.deb` | 适用于 `aarch64` / `arm64` 系统 |
...
| Linux DEB（x64） | `sudo dpkg -i easypostman_{版本号}_amd64.deb` |
| Linux DEB（ARM64） | `sudo dpkg -i easypostman_{版本号}_arm64.deb` |
...
- `x86_64` -> 选择 `amd64.deb` 或 `x86_64.rpm`
- `aarch64` -> 选择 `arm64.deb` 或 `aarch64.rpm`
